...
Widget _buildList(BuildContext context,List<DocumentSnapshot> snapshot){
    ...
    return Expanded(
      child: GridView.count(crossAxisCount: 3, childAspectRatio: 1/1.5,
      padding: EdgeInsets.all(3),
        children: searchResults.map((data) => _buildListListitem(context,data)).toList(),
      ),
    );
}

Widget _buildListListitem(BuildContext context, DocumentSnapshot data){
